...
- `_harmonic_intersection`: returns `None` for collections with more than 20
  ...
  `N/A (more than 20 independent harmonics)` in those cases.
- Docstrings added to all public methods: `Pitch.__init__`, `Pitch.get_enharmonics`,
  ...
  `Pitch.write_enharmonics_info_to_txt`, `PitchCollection.__init__`, `PitchCollection.print_info`.
